...
function _omb_theme_PROMPT_COMMAND() {
    ...
    python_venv="$_omb_prompt_olive${VIRTUALENV}"
    local base_directory="${_omb_prompt_bold_teal}\W${_omb_prompt_reset_color}"
    local GIT_THEME_PROMPT_PREFIX="${_omb_prompt_bold_navy} ${_omb_prompt_bold_brown}"
    local SVN_THEME_PROMPT_PREFIX="${_omb_prompt_bold_navy} ${_omb_prompt_bold_brown}"
    local HG_THEME_PROMPT_PREFIX="${_omb_prompt_bold_navy}${_omb_prompt_bold_brown}"
    ...
    PS1="${python_venv}${base_directory} "
